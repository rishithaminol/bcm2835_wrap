...
extern "C" {
    ...
    */
    ...
    /* bcm2835_delay මඟින් අලුතින් `timespec` structure එකක් සෑම විටම සාදනු ලබයි.
    * මෙය වේගවත් ක්‍රියාවක් නොවන නිසා යුසර් විසින් කලින් සාදා දෙන `timespec` structure
    * එක මෙමඟින් දෙනලද millisecond වලට සකස් කරනු ලැබේ.
    * මමඟින් nanosleep කෙලින්ම භාවිතා කිරීමට හැකියාව ලැබේ.
    */
    extern void bcm2835_mk_msec(struct timespec *sleeper, unsigned int millis);
